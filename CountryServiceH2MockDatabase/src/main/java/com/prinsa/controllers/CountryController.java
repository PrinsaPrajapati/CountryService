package com.prinsa.controllers;
...
import com.prinsa.services.CountryService;
...
public class CountryController {
	...
	public ResponseEntity<AddResponse> deleteCountry(@PathVariable(value="id") int id) {
		try {
			AddResponse country= countryservice.deleteCountry(id);
			return new ResponseEntity<AddResponse>(country,HttpStatus.OK);
		}catch (Exception e) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}
